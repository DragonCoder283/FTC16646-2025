...
public class CMD_Intake extends SequentialCommandGroup {
    public CMD_Intake(SUB_SubBucket p_subBucket, SUB_Bucket p_bucket, SUB_SubBucketSlide p_subbucketslide, SUB_BucketLift p_bucketlift, GlobalVariables p_variables) {
        addCommands(
                new ConditionalCommand(
                        new CMD_IntakeWall(p_bucketlift, p_variables),
                        new CMD_IntakeSub(p_subBucket, p_bucket, p_subbucketslide, p_variables),
